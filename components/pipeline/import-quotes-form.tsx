...
const csvTemplate = [
  "Code_Representant;Code Devis;Date;Date de relance a realiser;Etat;Taux de concretisation;Entreprise(ou nom_client);Sujet;Temps total;debourse total;total HT Net;Date de concretisation;Telephone",
  "REP01;D-2026-001;26/06/2026;03/07/2026;Envoye;70;Exemple Paysage;Cuisine exterieure sur mesure;4;1200;25000;;0600000000"
].join("\n");
      ...
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          ...
          <p className="mt-2 text-sm leading-6 text-muted">
            Les devis importes alimentent directement le pipeline. Un numero de devis deja present met a jour la carte existante.
          </p>
        ...
        <form action={formAction} className="grid gap-4">
          ...
          <div className="rounded-md border border-border bg-background p-4 text-sm text-muted">
            ...
            <p className="mt-2">Obligatoires : Entreprise(ou nom_client), Code Devis, Etat, total HT Net.</p>
            <p>Le Code_Representant doit correspondre au code saisi sur la fiche utilisateur.</p>
          </div>
